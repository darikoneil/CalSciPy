...
def test_factorized_matrix(factorized_matrix):
    # single_component
    for component_ in range(3):
        component_matrix = merge_factorized_matrices(factorized_matrix, components=component_)
    ...
    # multi component
    components = merge_factorized_matrices(factorized_matrix, components=[0, 2])
    comps = [merge_factorized_matrices(factorized_matrix, components=c) for c in [0, 2]]
